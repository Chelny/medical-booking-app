...
export const Regex = {
  BIRTH_DATE_PATTERN: /^[1-9][0-9]{3}-(0[1-9]|1[0-2])-(0[0-9]|[1-2][0-9]|3[0-1])$/,
  EMAIL_PATTERN:
   ...
   */
  MEDICAL_ID_PATTERN: /^[A-Z]{4}-?[0-9]{4}-?[A-Z]{5}$/,
  /**
   * Password Pattern
   ...
   *   - (123) 456-7890
   */
  PHONE_NUMBER_PATTERN: /^(([0-9]{10})|\([0-9]{3}\)\s[0-9]{3}-[0-9]{4})$/,
  PHONE_NUMBER_EXT_PATTERN: /^[1-9][0-9]{2,4}$/,
  /**
   * Postal Code Pattern
   * Canada: A0A 0A0
   * USA: 55555 OR 55555-5555
   */
  POSTAL_CODE_CA_PATTERN: /^[ABCEGHJ-NPRSTVXY]\d[ABCEGHJ-NPRSTV-Z][\s-]?\d[ABCEGHJ-NPRSTV-Z]\d$/,
  POSTAL_CODE_US_PATTERN: /^(?!0{5})(\d{5})(?!-?0{4})(|-\d{1,4})?$/,
  /**
   * Username Pattern
